...
|--------------------------------------------------------------------------
|
| Implements Wipe as part of the database package in the Gofreight
| framework. Key symbols: Wipe.
| 
...
| 
| Symbols defined here include: Wipe (Wipe drops all user tables in the
| connected database.).
| 
*/
